...
data = pd.read_csv('~/Documents/School_Work/Fall_2017/CS4641/Assignment3/part2/Randomized_Projection'
                   '/Rand_Cancer_reduced.csv', names=col)
...
# #ax1.text(2.5, 100, 'k=2', verticalalignment='center')
# ax2.axvline(x=6, ls='--',  c='black')
# ax1.axhline(y = 125, ls='--',  c='black')
# ax1.text(6.5, 1500, 'k=6', verticalalignment='center')
#
#
# plt.title('Wisconsin Cancer RP-reduced dataset')
...
df.to_csv('RP+KM_clusters.csv', index=0, header=0)
...
#
# plt.savefig('Wisconsin cancer RP-reduced dataset')
#
#
