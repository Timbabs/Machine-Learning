...
data = pd.read_csv('~/Documents/School_Work/Fall_2017/CS4641/Assignment3/part2/PCA/pca_cancer_reduced.csv', names=col)
...
df.to_csv('PCA+KM_clusters.csv', index=0, header=0)
