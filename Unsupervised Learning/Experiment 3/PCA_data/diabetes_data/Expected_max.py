...
data = pd.read_csv('~/Documents/School_Work/Fall_2017/CS4641/Assignment3/part2/PCA/pca_diabetes_reduced.csv', names=col)
...
#
#
# plt.title('Pima Diabetes PCA-reduced dataset')
...
#
# plt.title('EM on Pima Diabetes PCA-reduced dataset')
