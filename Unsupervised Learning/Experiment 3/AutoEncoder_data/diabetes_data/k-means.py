...
# ax1.text(2.5, 2E-9, 'k=2', verticalalignment='center')
# ax2.axvline(x=10, ls='--',  c='black')
# ax1.axhline(y = 0.1E-9, ls='--',  c='black')
# ax1.text(10.5, 3E-9, 'k=10', verticalalignment='center')
#
#
# plt.title('Pima Indian Diabetes PCA-reduced dataset')
...
plt.plot(C[:, 0], C[:, 1], marker='*', alpha=0.1, c='black', ms=15)

plt.savefig('diabetes2.png', dpi=300)
plt.title('Pima Diabetes AutoEncoder-reduced data')
