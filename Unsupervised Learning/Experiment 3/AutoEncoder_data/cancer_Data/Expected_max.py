...
data = pd.read_csv('~/Documents/School_Work/Fall_2017/CS4641/Assignment3/part2/'
                   'AutoEncoders/AutoEncoder_Cancer_reduced.csv', names=col)
...
# #ax1.text(2.1, 4700, 'n=2', verticalalignment='center')
#
#
#
# plt.title('Wisconsin Cancer AutoEncoders-reduced dataset')
...
df.to_csv('AE+EM_clusters.csv', index=0, header=0)
...
# plt.scatter(X[:, 0], X[:, 1], c=label_color, alpha=0.1)
#
# import matplotlib
#
...
#
# plt.title('EM on Wisconsin Cancer AutoEncoders-reduced data')
