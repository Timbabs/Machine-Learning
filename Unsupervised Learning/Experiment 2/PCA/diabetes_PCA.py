...
#
# x22, y22, _ = proj3d.proj_transform((pca.mean_)[0], (pca.mean_)[1], (pca.mean_)[2], ax.get_proj())
# v0 = (x22, y22)
#
# def draw_vector(v):
...
#     x2, y2, _ = proj3d.proj_transform((pca.mean_ + v)[0], (pca.mean_ + v)[1], (pca.mean_ + v)[2], ax.get_proj())
#     v = (x2, y2)
#     draw_vector(v)
#
...
# plt.savefig('inputProj.png', dpi=300)
# pylab.show()
...
# plt.savefig('principalProj.png', dpi=300)
# plt.show()
...
# # df.to_csv('pca_diabetes_reduced.csv', index=0, header=0)
#
# X_new = pca.inverse_transform(X_pca)
#
#
# ax.scatter(X[:, 0], X[:, 1], X[:, 2], alpha=0.2, label='original data (3 features)')
# ax.scatter(X_new[:, 0], X_new[:, 1], X[:, 2], alpha=0.8, label='projected data (2 components)')
# ax.legend(loc='best')
#
# #plt.savefig('comboProj.png', dpi=300)
# pylab.show()
